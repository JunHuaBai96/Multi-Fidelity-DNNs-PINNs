...
def main():
    ...
    # Note: tensorflow.contrib (including ScipyOptimizerInterface) is not available in TF2.
    # We proceed with Adam optimization only for TF2 compatibility.
    ...
    # In TF2 environments, skip L-BFGS refinement since tensorflow.contrib is unavailable.
